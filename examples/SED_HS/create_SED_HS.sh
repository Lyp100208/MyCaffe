...
$EXAMPLES/convert_sed_hs_data.bin $DATA/sed_hs_pos_test.list 1 $DATA/sed_hs_neg_test.list 0 sed_hs-test-leveldb 3
$EXAMPLES/convert_sed_hs_data.bin $DATA/sed_hs_pos_train.list 1 $DATA/sed_hs_neg_train.list 0 sed_hs-train-leveldb 3
